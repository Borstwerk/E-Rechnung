...
namespace EInvoiceSender.Application.UseCases;
...
public sealed partial class CreateEInvoiceUseCase : ICreateEInvoiceUseCase
{
    ...
    private readonly ILogger<CreateEInvoiceUseCase> _logger;

    private const int TotalSteps = 9;

    public CreateEInvoiceUseCase(
        ...
        ILogger<CreateEInvoiceUseCase> logger)
    {
